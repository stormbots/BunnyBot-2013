...
public class Chassis extends Subsystem {
    ...
    Solenoid gearShifter1 = RobotMap.chassisGearShifter1;
    ...
    public void JoystickControl(Joystick stick) {
        ...
        a = a*OI.MotorSpeedMultiplier*(OI.LEFT_RIGHT_DIRECTION? -1 : 1);
        double b = stick.getRawAxis(OI.FORE_BACK_STICK);
        b = b*OI.MotorSpeedMultiplier*(OI.FORE_BACK_DIRECTION? -1 : 1);
        manualControl(b,a);
    }
