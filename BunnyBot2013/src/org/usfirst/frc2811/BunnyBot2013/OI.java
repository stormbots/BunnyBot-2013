...
public class OI {
    ...
    public static JoystickButton slowDownButton;
    ...
    public static double MotorSpeedMultiplier;//not implemented yet, but will allow holding button to slow down robot
    ...
    public OI() {
        ...
        changeTarget = new JoystickButton(joystick, 2);
